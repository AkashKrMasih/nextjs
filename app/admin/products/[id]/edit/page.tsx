  ...
  return (
    <main className="mx-auto max-w-2xl px-4 md:px-6 py-10">
      ...
      <div className="mt-4 flex items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl leading-tight tracking-tight text-stone-900">
            Edit product
          </h1>
        ...
        <Link
          ...
          className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-stone-200 px-4 py-2 text-sm font-medium text-stone-900 transition-colors hover:bg-stone-100"
        >
